...
<HEAD>
	    <title>IntraBSC - Solução em Planejamento Estratégico</title>
		<url>www.intrabsc.com</url>
		<description>Solução em Planejamento Estratégico e Gestão de Planos de Ação</description>
										...
										<tr>
											...
											<td valign="top">
												<table border="0" style="vertical-align: top; ">
													...
													Solução em Planejamento Estratégico e Planos de Ações
       												</td></tr>
       												...
       												<td colspan="0" class="tituloVerde1">Todos alinhados ao negócio da empresa</td></tr>
       												<tr>
       												<td colspan="0" class="texto1" >
               											O IntraBSC é um software de gestão que agrega valor ao negócio da sua empresa, 
               										melhorando a perfomance dos processos e levando a estratégia a todos os funcionários.
               										</td>
               										</tr>
       												<tr><td colspan="0" >&nbsp;</td></tr>
       												<tr><td class="tituloVerde1" colspan="0" >Transformando a estratégia em ações</td></tr>
													<tr><td class="texto1" >
