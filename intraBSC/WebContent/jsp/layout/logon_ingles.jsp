...
<HEAD>
	    <title>IntraBSC - Solution in Strategic Planning</title>
		<url>www.intrabsc.com</url>
		<description>Solution in Strategic Planning and e Action Plan Management</description>
										...
										<tr>
											...
											<td valign="top">
												<table border="0" style="vertical-align: top; ">
													...
													Solution in Strategic Planning and e Action Plan Management
       												</td></tr>
       												...
       												<td colspan="0" class="tituloVerde1">All aligned at the company`s business </td></tr>
       												<tr>
       												<td colspan="0" class="texto1" >
               											The IntraBSC is a software by management that value aggregate to your company`s business, 
               										improving perform of processes and taking the strategy for all employers.
               										</td>
               										</tr>
       												<tr><td colspan="0" >&nbsp;</td></tr>
       												<tr><td class="tituloVerde1" colspan="0" >Transforming the strategy in actions</td></tr>
													<tr><td class="texto1" >
														Defina a estratégia, declare os objetivos que precisam ser alcançados
													estabeleça metas. O plano de ações declara quem faz o quê. 
													A colaboração pecisa ser estimulada entre todos.
													</td>
													</tr>
													</table>
													</td>
													...
													<tr><td colspan="2">&nbsp;</td></tr>
       												...
       												<tr>
														<td colspan="0">
               											...
               											<td colspan="0">
               											<table>
               												<tr><td class="tituloVerde1" colspan="0" style="text-align: right" >Como está a perfomance?</td></tr>
															<tr>
															<td colspan="0" class="texto1" style="text-align: right" >
																As ações do dia a dia precisam ser medidas, avaliadas e corrigidas quando necessário.
															Os indicadores e metas mostram os resultados do negócio. 
															</td>
															</tr>
															<tr><td colspan="0" >&nbsp;</td></tr>
															...
															<tr><td colspan="0" class="texto1" style="text-align: right">
 																As informações estão contidas nas ações das equipes e devem ser guardadas de maneira organizadada.
 																As boas práticas são utilizadas e os processos amadurecem.</td>
															</tr>
														</table>
														</td>
													</tr>	
											...
											<td valign="top" width="200px">
												<table  border="0"  >
													<tr><td class="titulo3">&nbsp;&nbsp;Downloads:</td></tr>
													<tr height=2></tr>
													<tr>
														<td class="texto1">&nbsp;&nbsp;
															<img src="<c:out value="${base}"/>/WEB/imagens/comum/pdf.jpg" border="0" style="vertical-align: text-bottom">
															<a href="<c:out value="${base}"/>/folder.do?op=downloadFolderProduto">A Solução IntraBSC</a>
														</td>
													</tr>
													<tr>
														<td class="texto1" >&nbsp;&nbsp;
													...
													<tr>
														<td class="texto1">&nbsp;&nbsp;
															<img src="<c:out value="${base}"/>/WEB/imagens/comum/pdf.jpg" border="0" style="vertical-align: text-bottom">
															<a href="<c:out value="${base}"/>/folder.do?op=downloadFolderTecnico">Especificações Técnicas</a>
														</td>
													</tr> 
													<tr height=5></tr>
											...
											<tr>
												<td class="texto1">
												&nbsp;&nbsp;&nbsp; <b><u><font color="blue">acesso.intrabsc@gmail.com</font></u></b>  	
												</td>
											</tr>
											<tr>
