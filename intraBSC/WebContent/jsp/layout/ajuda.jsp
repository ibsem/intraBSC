      ...
      <table cellpadding="0" cellspacing="0" >
        <tr>
        	<td class="texto1">&nbsp;&nbsp;
				...
				onclick="abrirAjuda();">
				<a onclick="abrirAjuda();">Manual do Usuário em HTML</a>
			</td>
		</tr>
       <tr>
        	<td class="texto1">&nbsp;&nbsp;
				<img src="<c:out value="${base}"/>/WEB/imagens/comum/pdf.jpg" border="0" style="vertical-align: text-bottom">
				<a href="<c:out value="${base}"/>/folder.do?op=downloadManualOperacao">Manual do Usuário em PDF</a>
			</td>
		</tr>
    <tr>
        	<td class="texto1">&nbsp;&nbsp;
		...
		<tr>
			<td class="texto1">&nbsp;&nbsp;
				<img src="<c:out value="${base}"/>/WEB/imagens/comum/pdf.jpg" border="0" style="vertical-align: text-bottom">
				<a href="<c:out value="${base}"/>/folder.do?op=downloadFolderTecnico">As Especificações Técnicas</a>
			</td>
		</tr>
