...
<html:html>
	<html:form action="/fase/manutencao.do?op=incluir" onsubmit="return validateFaseForm(this);">
		<table width="400px" border="0" cellspacing="0" cellpadding="0" >
			<tr height="3">
				<td>&nbsp;</td>
			</tr>
			<tr>
			    <td colspan="2" valign = "center" class="titulo" style="border-bottom:thin; border-bottom-style:solid;"><bean:message key="bsc.label.incluirfase"/></td>  
			</tr>
			...
			<tr>
				<td colspan="2"><html:textarea name="faseForm" property="descricao" cols="68" rows="5" style="width:400px"/></td>
		</table>
