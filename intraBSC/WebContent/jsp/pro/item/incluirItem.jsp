...
<script language="javascript" type="text/javascript">
	...
	function incluir(){
		...
		document.itemForm.action = "<c:out value="${base}"/>/item/incluir.do?op=incluir&tipoParticipacao=1&formAnce=configTarefaForm&acao=<c:out value="${base}"/>/configTarefa/consultarUm.do?op=consultarUm&codigoConfigTarefa="+codTipo;
		document.itemForm.submit();		
	}
	
</script>

<html:form action="/item/incluir" onsubmit="return validateItemForm(this);">
			...
			<table border="0" width="385px" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<td ><html:select property="codigoDadoItem" onchange="habilitaCombo();" style="width:65px">
