...
void draw( Graphics2D g2, float stroke, Color corSeta )
{


g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING,RenderingHints.VALUE_ANTIALIAS_ON);
//float dashes []={10};
//g2.setStroke(new BasicStroke(stroke,BasicStroke.CAP_SQUARE,BasicStroke.JOIN_ROUND,5,dashes,2));
...
g2.drawPolygon(getArrow(x1, y1, x2, y2, 5, 0,0.5)); //startx,starty,endx,endy,headsize,difference,factor

g2.fillPolygon(getArrow(x1, y1, x2, y2, 5, 0,0.5));
