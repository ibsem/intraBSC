...
import br.com.intraBSC.util.JCommonDrawableRenderer;


public class GantPlanoAcoesScriptlet extends JRDefaultScriptlet
{

    private int linhas;

     
	public GantPlanoAcoesScriptlet()
    {
    }
    ...
    public JFreeChart createChart(IntervalCategoryDataset intervalcategorydataset)
    {
        ...
        textoTitulo.setText("");
        JFreeChart jfreechart = ChartFactory.createGanttChart(textoTitulo.getText(), "Atividade", "Período", intervalcategorydataset, true, true, false);
        ...
        throws JRScriptletException
          {
    		...
    		try{ 
	  		dataset.executeQuery("SELECT PA.cd_usu || '-' || rTRIM(char(atvd.nr_seql_ATVD)) ||'-' || rTRIM(nm_ATVD) as atividade , " +
    ...
    public void afterReportInit()
        throws JRScriptletException
    {
    	//observar no original como alterar o numero de linhas caso existam muitas ações
